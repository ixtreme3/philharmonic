...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<Object[]> getEventsByCulturalBuildingName(@Param("param") String param);
    ...
    List<Object[]> getEventsBetweenDates(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    List<Object[]> getEventsByOrganizerName(@Param("param") String param);
